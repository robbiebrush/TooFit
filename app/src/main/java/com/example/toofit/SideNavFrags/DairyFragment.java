...
import com.example.toofit.ViewPager.CustomViewPageAdapterDairy;
...
public class DairyFragment extends Fragment {
    ...
    public static DairyFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager2.setAdapter(new CustomViewPageAdapterDairy(getActivity()));
        return view;
    }
}